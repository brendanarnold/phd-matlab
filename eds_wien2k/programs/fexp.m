...
fprintf(fid,'%16.10e %16.10e %16.10e %16.10e %16.10e %16.10e %i %i %i %i %i\r\n',...
    [0 0 0], mcell(1)*new_prim_gridsp(1),mcell(2)*new_prim_gridsp(2),mcell(3)*new_prim_gridsp(3),...
    newcartdims,bands.Wien2k_bandnums(1),bands.Wien2k_bandnums(end));
%ignoring submesh shift for now
fclose(fid);
...
copyfile(['C:\TonyC\Wien2K\Boltztrap\FexpSource\Fexp\Debug' '\fexp.exe'],'fexp.exe');
